...
@Component({
    ...
    imports: [BreadcrumbComponent, SkeletonBlogComponent, NgClass, PaginationComponent, NoDataComponent, BlogSidebarComponent, AsyncPipe, DatePipe, SummaryPipe, TranslateModule]
})
